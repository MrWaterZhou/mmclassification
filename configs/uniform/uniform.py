...
data = dict(
    ...
    train=dict(
        ...
        ann_file=["data/uniform/train.txt"],
    ...
    test=dict(
        ...
        ann_file="data/uniform/eval.txt",
        pipeline=test_pipeline))
load_from = "work_dirs/human_finetune/finetune.pth"
evaluation = dict(interval=5, metric=["mAP", "CP", "CR", "CF1", "OP", "OR", "OF1"],labels=["uniform","normal"])
