...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/zhou/projects/mmclassification/data/porn/20220403/train.txt',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix='',
        classes=['性感_胸部', '色情_女胸', '色情_男下体', '色情_口交', '性感_内衣裤', '性感_男性胸部', '色情_裸露下体', '性感_腿部特写', '正常'],
        ann_file='/home/zhou/projects/mmclassification/data/porn/20220403/eval.txt',
...
# optimizer
optimizer = dict(type='SGD', lr=0.4, momentum=0.9, weight_decay=5e-5)
