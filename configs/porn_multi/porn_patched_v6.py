...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/zhou/projects/mmclassification/data/porn/porn_with_patch/train.v4.txt',
...
evaluation = dict(interval=5, metric=['mAP', 'CP', 'CR', 'CF1', 'OP', 'OR', 'OF1'],labels=['性感_胸部', '色情_女胸', '色情_男下体', '色情_口交', '性感_内>衣裤', '性感_男性胸部', '色情_裸露下体', '性感_腿部特写'])
